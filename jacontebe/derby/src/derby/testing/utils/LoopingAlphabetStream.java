 ...
 * alphabet.
 */
public class LoopingAlphabetStream extends InputStream implements Resetable {
     ...
     * 
     * @param length
     *            the number of characters (and also the number of bytes)
     */
     ...
     * 
     * @param bufSize
     *            the wanted size, might be ignored if too big
     */
