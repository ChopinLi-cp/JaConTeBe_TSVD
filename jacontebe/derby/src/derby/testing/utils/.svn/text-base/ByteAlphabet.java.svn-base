 ...
 * <ul>
 * <li><em>Modern latin, lowercase</em> ; letters a - z (26)
...
public class ByteAlphabet {
    ...
    public static ByteAlphabet cjkSubsetUTF16BE() {
        return new ByteAlphabet("CJK subset, UTF-16BE", CharAlphabet.CJKSUBSET,
                "UTF-16BE");
    }
    ...
    public static ByteAlphabet cjkSubsetUTF8() {
        return new ByteAlphabet("CJK subset, UTF-8", CharAlphabet.CJKSUBSET,
                "UTF8");
    }

    /**
     * Create an alphabet returning bytes representing the lowercase letters a-z
     * in the "US-ASCII" encoding.
     */
    public static ByteAlphabet modernLatinLowercase() {
        return new ByteAlphabet("Modern latin lowercase, US-ASCII",
                CharAlphabet.MODERNLATINLOWER, "US-ASCII");
    }

    /**
     * Create an alphabet returning bytes representing the 29 lowercase letters
     * in the Norwegian/Danish alphabet in the "ISO-8859-1" encoding.
     */
    public static ByteAlphabet norwegianLowercase() {
        return new ByteAlphabet("Norwegian/Danish lowercase, ISO-8859-1",
                CharAlphabet.NO_DK_LOWER, "ISO-8859-1");
    }
    ...
    public static ByteAlphabet tamilUTF16BE() {
        return new ByteAlphabet("Tamil, UTF-16BE", CharAlphabet.TAMIL,
                "UTF-16BE");
    }
     ...
     * @param encoding
     *            the encoding to use to represent characters as bytes
     */
     ...
     * 
     * The number of bytes in the alphabet is noramlly different from the number
     * of characters in the alphabet, but it depends on the characters in the
     * alphabet and encoding used to represent them as bytes.
     */
    ...
    /**
     * Compute the next byte to read after reading the specified number of
     * bytes.
     * 
     * Besides from returning the index, the internal state of the alphabet is
     * updated.
     * 
     * @param bytesRead
