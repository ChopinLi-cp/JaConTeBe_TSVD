 ...
 * 
 * The alphabet loops over a list of characters. The alphabet-object is used by
 * looping readers, which in turn is used for testing methods requiring
 * streaming inputs.
 * 
...
public class CharAlphabet {
    ...
    public static char[] MODERNLATINLOWER = { 'a', 'b', 'c', 'd', 'e', 'f',
            'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's',
            't', 'u', 'v', 'w', 'x', 'y', 'z' };

    /** Norwegian/Danish alphabet, lowercase; 29 letters */
    public static char[] NO_DK_LOWER = { 'a', 'b', 'c', 'd', 'e', 'f', 'g',
            'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't',
            'u', 'v', 'w', 'x', 'y', 'z', '\u00E6', '\u00F8', '\u00E5' };

    /** Subset of Tamil alphabet; 46 letters, UNICODE U0B80 */
    public static char[] TAMIL = { '\u0B85', '\u0B86', '\u0B87', '\u0B88',
            '\u0B89', '\u0B8A', '\u0B8E', '\u0B8F', '\u0B90', '\u0B92',
            '\u0B93', '\u0B94', '\u0B95', '\u0B99', '\u0B9A', '\u0B9C',
            '\u0B9E', '\u0B9F', '\u0BA3', '\u0BA4', '\u0BA8', '\u0BA9',
            '\u0BAA', '\u0BAE', '\u0BAF', '\u0BB0', '\u0BB1', '\u0BB2',
    ...
    public static char[] CJKSUBSET = { '\u4E00', '\u4E01', '\u4E02', '\u4E03',
            '\u4E04', '\u4E05', '\u4E06', '\u4E07', '\u4E08', '\u4E09',
            '\u4E0A', '\u4E0B' };
    ...
    public static CharAlphabet cjkSubset() {
        return new CharAlphabet("CJK subset", CharAlphabet.CJKSUBSET);
    }
    ...
    /**
     * Compute the next character to read after reading the specified number of
     * characters.
     * 
