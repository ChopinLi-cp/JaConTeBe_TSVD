...
public class _TestUtil {
    ...
    /**
     * Returns temp dir, containing String arg in its name; does not create the
     * directory.
     */
    public static File getTempDir(String desc) {
        ...
        if (tempDir == null)
            throw new RuntimeException(
                    "java.io.tmpdir undefined, cannot run test");
    ...
    /**
     * This runs the CheckIndex tool on the index in. If any issues are hit, a
     * RuntimeException is thrown; else, true is returned.
     */
